...
The implemantation [lensHub subgraph](https://github.com/protofire/lens-protocol-subgraph)) with [Squid SDK docs](https://docs.subsquid.io/) for a complete reference.
...
# 1. clone repository
sqd clone https://github.com/nashirudin/lens-migrtion
